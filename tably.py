...
HEADER_TX = r"""\begin{{table}}[!htb]
{indent}\centering{caption}{label}
{indent}\begin{{tabularx}}{{\linewidth}}{{{align}}}
{indent}{indent}\toprule"""

FOOTER_TX = r"""{indent}{indent}\bottomrule
{indent}\end{{tabularx}}
\end{{table}}"""
...
class Tably:
    ...
    def create_table(self, file):
        ...
        if not self.fragment:
            if self.tabularx:
                print()
                header = HEADER_TX.format(
                label=add_label(self.label, indent),
                caption=add_caption(self.caption, indent),
                align=format_alignment(self.align, len(columns), self.tabularx),
                indent=indent,
                )
            else:
            ...
            foot = FOOTER_TX if self.tabularx else FOOTER
            footer = foot.format(indent=indent)
...
def format_alignment(align, length, tabularx=False):
